...
export const GAMES: GameBundle<GameMeta>[] = [
  ...
  },
  {
    ...
    meta: {
      ...
      name: "踩地雷",
      image: "/games/logo.png",
      description: `踩地雷是戰略的傑作，玩家在尋找隱藏寶藏的同時要謹慎揭開方格，因為隱藏的地雷可能隨時結束你的探險。每次揭開都會增加風險，為勇敢的玩家帶來充滿懸念和精心計算風險的心跳體驗，保證一場難忘的遊戲冒險。`,
      volatility: 2,
    },
  ...
  },
  {
    ...
    meta: {
      ...
      name: "俄羅斯輪盤",
      image: "/games/logo.png",
      description: `俄羅斯輪盤將經典的輪盤遊戲融入數位創新中。下注並見證轉輪的迷人景象，決定你的命運。簡單但迷人的玩法和豐厚獎勵的吸引力，輪盤成為了機會與財富的象徵，保證無盡的興奮與期待。`,
      volatility: 3,
    },
  ...
  },
  {
    ...
    meta: {
      ...
      name: "彈珠檯",
      image: "/games/logo.png",
      description: `彈珠檯將投幣的動作轉化為藝術，每一個彈珠都充滿著期待與策略的融合。見證籌碼在釘板上滑落，隨機落在不同的獎勵槽中。每一次投幣都是運氣和技巧之間的微妙平衡，使彈珠檯成為一次充滿機會與策略的迷人旅程。`,
      volatility: 3,
    },
  ...
  },
  {
    ...
    meta: {
      ...
      name: "嫦娥登月",
      image: "/games/logo.png",
      description: `預測一個倍數目標，然後看嫦娥是否能達到該目標。如果嫦娥在達到目標前墜毀，玩家就會失敗；如果達到或超過目標，玩家就會獲勝。`,
      volatility: 5,
    },
  ...
  },
  {
    ...
    meta: {
      ...
      name: "BINGO",
      image: "/games/logo.png",
      description: `BINGO邀請玩家進入一個充滿戰略決策和期待的世界，每一個選擇都蘊藏著無限的財富潛力。選擇多達 10 個方塊並下注，期待決定你命運的抽籤。無論是選擇較少的數字以獲得豐厚獎勵，還是選擇較多的數字以增加成功機率，BINGO都保證帶來充滿興奮和可能性的體驗。`,
      volatility: 4,
    },
